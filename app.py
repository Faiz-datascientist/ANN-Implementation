...
st.write("Just Implemented using Artifical Neural Network")

geography = st.selectbox("Geography", LabelEncoder_geo.categories_[0])
...
geo_encoded = LabelEncoder_geo.transform([[geography]])
geo_encoded_df = pd.DataFrame(geo_encoded, columns=LabelEncoder_geo.get_feature_names_out(['Geography']))
